          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white mb-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-green-300">+{totalReturn}%</p>
              </div>
              <div>
                <p className="text-xs text-blue-100 mb-1">현재 선택된 존</p>
                <p className="text-lg font-semibold">{getZoneLabel(todayZone)}</p>
              </div>
            </div>
          </div>
