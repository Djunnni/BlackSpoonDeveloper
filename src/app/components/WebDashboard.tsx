...
import { ArrowUpRight, Shield, TrendingUp, Scale, BarChart3, PieChart, Activity, Bell, Wallet, Settings as SettingsIcon } from 'lucide-react';
...
export function WebDashboard() {
  ...
  const [selectedView, setSelectedView] = useState<'overview' | 'zone' | 'map' | 'charge' | 'notifications'>('overview');
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">JB머니 Dashboard</h1>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-3 space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-white">
              ...
              <h2 className="text-3xl font-bold mb-6">{totalBalance.toLocaleString()}원</h2>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center pb-3 border-b border-blue-400">
                  ...
                  <span className="font-semibold text-green-300">+{totalProfit.toLocaleString()}원</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-blue-100">일 수익률</span>
                  <div className="flex items-center gap-1">
                    <ArrowUpRight className="w-4 h-4 text-green-300" />
                    <span className="font-semibold text-green-300">+{totalReturn}%</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {selectedView === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-white rounded-2xl p-6 border border-gray-200">
                    <h3 className="font-semibold text-gray-900 mb-4">잔액 추이</h3>
                  ...
                  <div className="bg-white rounded-2xl p-6 border border-gray-200">
                    <h3 className="font-semibold text-gray-900 mb-4">일별 이자 발생</h3>
                    <ResponsiveContainer width="100%" height={250}>
                      <LineChart data={DAILY_CHART_DATA}>
                        ...
                        <YAxis stroke="#9ca3af" style={{ fontSize: '12px' }} />
                        <Tooltip />
                        <Line type="monotone" dataKey="interest" stroke="#10b981" strokeWidth={2} dot={{ fill: '#10b981', r: 4 }} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-4 gap-4">
                  <div className="bg-white rounded-xl p-4 border border-gray-200">
                    <p className="text-sm text-gray-600 mb-1">이번 달 누적 이자</p>
                  ...
                  <div className="bg-white rounded-xl p-4 border border-gray-200">
                    ...
                    <p className="text-xl font-bold text-gray-900">3,937,500원</p>
                  </div>
                  <div className="bg-white rounded-xl p-4 border border-gray-200">
                    <p className="text-sm text-gray-600 mb-1">전날 대비</p>
                    <p className="text-xl font-bold text-purple-600">▲ 12,300원</p>
                  </div>
                </div>
              </div>
            )}
